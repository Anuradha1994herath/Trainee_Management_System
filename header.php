...
<body>
            ...
            <ul class="nav navbar-nav ">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
						...
						<li><a href="Feedback.php">Evaluation</a></li>
						<li><a href="downloads.php">Assignment Download</a></li>
						<li><a href="applybyid.php">Certifiacate Apply Form</a></li>
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            ...
            <li><a href="allowance.php">Allowance Form</a></li>
			<li><a href="results.php">A/L And University Results</a></li>
			 <li><a href="tblapply.php">Certificate Apply Details</a></li>
			 <li><a href="schedule.php">Schedule Details</a></li>
...
<li class="dropdown">
    ...
    <ul class="dropdown-menu">
        ...
        <li><a href="rptfeedback.php">Feedback Details</a></li>
		<li><a href="feedbackreport.php">Trainee Feedback Details</a></li>
		<li><a href="index2.php">Assignment Uploads</a></li>
		<li><a href="subjectadd.php">Subject Maintenance</a></li>
    </ul>
</li>
<?php 
else:?>
