...
<!--  <div class="container col-md-6 col-md-offset-3">
 ...
 <div class="form-group">
                            <label for="inputText2" class="col-sm-4 control-label">RFID Number </label>
                            <div class="col-sm-8">
                                

<!-- <th style="padding-top: 20px;"><label>RFID Number</label>
              <td style="width: 200px; padding-right: 30px;padding-top: 20px;padding-left: 10px;">

              --><select class="form-control" name="ID_number" id="ID_number"> 
                <option>--SELECT--</option>
                <?php
                $sql = "SELECT *  FROM tbl_rfid WHERE flag = 'DEACTIVE' ";
