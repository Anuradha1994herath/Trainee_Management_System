...
//data catchiing
    ...
    if ($_POST["v_institute"] == 0) {
        $tblTrainingInstituteID_err = "Please select ";
    } else {
...
echo $ProgramName;
 ...
 $sql2 = "INSERT INTO tbl_results(Name_with_Initials,stream,sub1,res1,sub2,res2,sub3,res3,gentest,geneng,district,disrank,irank,zscore,gpa,com)
 VALUES('$Name_with_Initials', '$stream', '$sub1', '$res1', '$sub2', '$res2', '$sub3', '$res3', '$gt', '$ge', '$dis', '$dr', '$ir', '$zc', '$gpa','$com')";
    ...
    <form class="form-horizontal" method="post" action="#" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_batch" id="v_batch"
                                           placeholder="EX:2016/17" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                        echo $_POST['v_batch'];
                                    } ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
        ...
        <div class="container col-md-6 col-md-offset-3">
            <div class="panel-group">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">GCE (A/L) And University Results Details
                        </h4>
                    </div>
                    <div>
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="inputText2" class="col-sm-4 control-label">A/L Stream </label>
                                <div class="col-sm-8">
                                    <select class="form-control" name="v_stream" id="v_stream"
                                            value="<?php if (isset($_POST['btnSubmit'])) {
                                                echo $_POST['v_stream'];
                                            } ?>">
                                    ...
                                    <script type="text/javascript">
                                      document.getElementById('v_stream').value = "<?php echo $_POST['v_stream'];?>";
                                    </script>
                            ...
                            <div class="form-group">
										 ...
										 <label for="inputText2" class="col-sm-4 control-label">Subject and Result</label>
                                <div class="col-sm-4">
                                    <select class="form-control" name="v_sub" id="v_sub"
                                            value="<?php if (isset($_POST['btnSubmit'])) {
                                                echo $_POST['v_sub'];
                                            } ?>">
                                        <option value="NOT PROVIDED">--SELECT--</option>
                                        <?php
                                        $sql = "SELECT *  FROM tbl_subject WHERE flag = 'ACTIVE' ";
                                        $course_data = $con->query($sql);
                                        if ($course_data->num_rows >= 1) :
                                            while ($row = mysqli_fetch_assoc($course_data)) :?>
                                    ...
                                    <script type="text/javascript">
                                      document.getElementById('v_sub').value = "<?php echo $_POST['v_sub'];?>";
                                    </script>
                                ...
                                <!-- start -->
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="v_res1" id="v_res1"
                                           placeholder=" Result" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                        echo $_POST['v_res1'];
                                    } ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
								 ...
								 <label for="inputText2" class="col-sm-4 control-label">Subject and Result</label>
                                <div class="col-sm-4">
                                    <select class="form-control" name="v_sub2" id="v_sub2"
                                            value="<?php if (isset($_POST['btnSubmit'])) {
                                                echo $_POST['v_sub2'];
                                            } ?>">
                                        <option value="NOT PROVIDED">--SELECT--</option>
                                    ...
                                    <script type="text/javascript">
                                      document.getElementById('v_sub2').value = "<?php echo $_POST['v_sub2'];?>";
                                    </script>
                                ...
                                <!-- start -->
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="v_res2" id="v_res2"
                                           placeholder=" Result" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                        echo $_POST['v_res2'];
                                    } ?>">
                                </div>
                            ...
                            <div class="form-group">
								 ...
								 <label for="inputText2" class="col-sm-4 control-label">Subject and Result</label>
                                <div class="col-sm-4">
                                    <select class="form-control" name="v_sub3" id="v_sub3"
                                            value="<?php if (isset($_POST['btnSubmit'])) {
                                                echo $_POST['v_sub3'];
                                            } ?>">
                                        <option value="NOT PROVIDED">--SELECT--</option>
                                    ...
                                    <script type="text/javascript">
                                      document.getElementById('v_sub3').value = "<?php echo $_POST['v_sub3'];?>";
                                    </script>
                                ...
                                <!-- start -->
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="v_res3" id="v_res3"
                                           placeholder=" Result" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                        echo $_POST['v_res3'];
                                    } ?>">
                                </div>
                            ...
                            <div class="form-group">
                                <label for="inputText2" class="col-sm-4 control-label">Genaral Test Mark </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_gt" id="v_gt"
                                           placeholder="Genaral Test Mark" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                        echo $_POST['v_gt'];
                                    } ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                <label for="inputText2" class="col-sm-4 control-label">Genaral English Result </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_ge" id="v_ge"
                                           placeholder="Genaral English Mark" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                        echo $_POST['v_ge'];
                                    } ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                <label for="inputText2" class="col-sm-4 control-label">District </label>
                                <div class="col-sm-8">
                                    <select class="form-control" name="v_dis" id="v_dis"
                                            value="<?php if (isset($_POST['btnSubmit'])) {
                                                echo $_POST['v_dis'];
                                            } ?>">
                                        <option value="--NOT PROVIDED--">--SELECT--</option>
                                        ...
                                        <option value="Mulathiu">Mulathiu</option>
                                    ...
                                    <script type="text/javascript">
                                      document.getElementById('v_dis').value = "<?php echo $_POST['v_dis'];?>";
                                    </script>
                            ...
                            <div class="form-group">
                                <label for="inputText2" class="col-sm-4 control-label">District Rank</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_disR" id="v_disR"
                                           placeholder="District Rank" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                        echo $_POST['v_batch'];
                                    } ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                <label for="inputText2" class="col-sm-4 control-label">Island Rank</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_ir" id="v_ir"
                                           placeholder="Island Rank" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                        echo $_POST['v_ir'];
                                    } ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                <label for="inputText2" class="col-sm-4 control-label">Z Score</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_zc" id="v_zc"
                                           placeholder="Z Score" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                        echo $_POST['v_zc'];
                                    } ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
                            ...
                            <div class="form-group">
                                <label for="inputText2" class="col-sm-4 control-label">Cumulative GPA</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_gpa" id="v_gpa"
                                           placeholder="GPA" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                        echo $_POST['v_gpa'];
                                    } ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
							  ...
							  <div class="form-group">
                                <label for="inputText2" class="col-sm-4 control-label">Comment for London A/L Students</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="v_com" id="v_com"
                                           placeholder="Comment" onblur="this.value=this.value.toUpperCase()" value="<?php if (isset($_POST['btnSubmit'])) {
                                        echo $_POST['v_com'];
                                    } ?>">
                                </div>
                                <?php if (isset($_POST["btnSubmit"])) { ?>
